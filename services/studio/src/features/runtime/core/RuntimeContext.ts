...
import { executeHandler, executeCodeWithClosure } from "../kernel/HandlerExecutor";
...
// Export handler execution functions
export { executeHandler, executeCodeWithClosure };