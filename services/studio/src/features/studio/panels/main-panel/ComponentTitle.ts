import { setDraggingComponentInfo } from "@nuraly/runtime";
import { ComponentType, type ComponentElement } from "@nuraly/runtime/redux/store/component";
  ...
  render() {
    ...
    ${this.display ? html`
      ...
      >
        ...
        ${this.component.type ===ComponentType.Container && false ? html`
        <micro-app
      style=${styleMap({
      })}
