  ...
  render() {
    return html`
        <div class="container-outside">
                ...
                class="position-input margin-left" placeholder="margin left" value=${this.position.marginLeft}></nr-input>
                <nr-input 
                .size=${"default"}
                @valueChange="${(e) => this.updateAttribute("marginRight", e.detail.value)}"
                class="position-input margin-right" placeholder="margin right" .value=${this.position.marginRight}></nr-input>
                <nr-input 
                .size=${"default"}
                @valueChange="${(e) => this.updateAttribute("marginTop", e.detail.value)}"
                class="position-input margin-top" placeholder="margin top" .value=${this.position.marginTop}></nr-input>
                <nr-input 
                .size=${"default"}
                @valueChange="${(e) => this.updateAttribute("marginBottom", e.detail.value)}"

                class="position-input margin-bottom" placeholder="margin bottom" .value=${this.position.marginBottom}></nr-input>
            <div class="container ">
                <div class="padding-label">Padding</div>
                <nr-input 
                .size=${"default"}
                @valueChange="${(e) => this.updateAttribute("paddingLeft", e.detail.value)}"
                class="position-input padding-left" placeholder="padding left" .value=${this.position.paddingLeft}></nr-input>

                <nr-input 
                .size=${"default"}
                @valueChange="${(e) => this.updateAttribute("paddingRight", e.detail.value)}"

                class="position-input padding-right" placeholder="padding right" .value=${this.position.paddingRight}></nr-input>
                <nr-input 
                .size=${"default"}
                @valueChange="${(e) => this.updateAttribute("paddingTop", e.detail.value)}"

                class="position-input padding-top" placeholder="padding top" .value=${this.position.paddingTop}></nr-input>
                <nr-input
                @valueChange="${(e) => this.updateAttribute("paddingBottom", e.detail.value)}"
                 class="position-input padding-bottom" placeholder="padding bottom" .value=${this.position.paddingBottom}></nr-input>
