                ...
                if(selectedComponent) { 
                    const componentConfigs = {
                        "text_label": {
                            ...
                            themes: ["text_label_theme_container", "box_model_vertical_container"]
                        },
                        "text_input": {
                            parameters: ["text_input_blocks"],
                            handlers: ["studio_text_input_handler"],
                            themes: ["text_input_icon_theme_container", "box_model_vertical_container"]
                        },
                        "Textarea": {
                            parameters: ["textarea_blocks"],
                            handlers: ["studio_textarea_handler"],
                            themes: ["textarea_theme_container", "box_model_vertical_container"]
                        },
                        "Slider": {
                            parameters: ["slider_blocks"],
                            handlers: ["studio_slider_handler"],
                            themes: ["slider_theme_container", "box_model_vertical_container"]
                        },
                        "button_input": {
                            parameters: ["button_blocks"],
                            handlers: ["studio_button_handler"],
                            themes: ["studio_button_theme_container", "box_model_vertical_container"]
                        },
                        "checkbox": {
                            parameters: ["checkbox_blocks"],
                            handlers: ["studio_checkbox_handler"],
                            themes: ["checkbox_button_theme_container", "box_model_vertical_container"]
                        },
                        "Image": {
                            parameters: ["image_blocks"],
                            handlers: ["studio_image_handler"],
                            themes: ["box_model_vertical_container"]
                        },
                        "Datepicker": {
                            parameters: ["datepicker_block"],
                            handlers: ["studio_datepicker_handler"],
                            themes: ["studio_datepicker_theme_container", "box_model_vertical_container"]
                        },
                        "select": {
                            parameters: ["select_blocks"],
                            handlers: ["studio_select_handler"],
                            themes: ["studio_select_theme_container", "box_model_vertical_container"]
                        },
                        "Table": {
                            parameters: ["table_fields_collapse_container", "table_blocks"],
                            handlers: ["studio_table_handler"],
                            themes: ["select_component_text", "box_model_vertical_container"]
                        },
                        "Icon": {
                            parameters: ["icon_blocks"],
                            handlers: ["studio_icon_handler"],
                            themes: ["studio_icon_theme_container", "box_model_vertical_container"]
                        },
                        "Badge": {
                            parameters: ["badge_blocks"],
                            handlers: ["studio_badge_handler"],
                            themes: ["badge_theme_container", "box_model_vertical_container"]
                        },
                        "Tag": {
                            parameters: ["tag_blocks"],
                            handlers: ["studio_tag_handler"],
                            themes: ["tag_theme_container", "box_model_vertical_container"]
                        },
                        "vertical-container-block": {
                            parameters: ["container_blocks"],
                            handlers: ["studio_container_handler"],
                            themes: ["studio_container_theme_container", "box_model_vertical_container"]
                        },
                        "Card": {
                            parameters: ["card_blocks"],
                            handlers: ["studio_card_handler"],
                            themes: ["card_theme_container", "box_model_vertical_container"]
                        },
                        "Collection": {
                        ...
                        "RefComponent": {
                            ...
                            themes: ["studio_ref_component_theme_container", "box_model_vertical_container"]
                        },
                        "code-block": {
                        ...
                        "rich-text": {
                            ...
                            themes: ["studio_rich_text_theme_container", "box_model_vertical_container"]
                        },
                        "rich-text-editor": {
                            parameters: ["rich_text_editor_blocks"],
                            handlers: ["studio_rich_text_editor_handler"],
                            themes: ["studio_rich_text_editor_theme_container", "box_model_vertical_container"]
                        },
                        "menu": {
                            parameters: ["menu_blocks"],
                            handlers: ["studio_menu_handler"],
                            themes: ["studio_menu_theme_container", "box_model_vertical_container"]
                        },
                        "dropdown": {
                            parameters: ["dropdown_blocks"],
                            handlers: ["studio_dropdown_handler"],
                            themes: ["studio_dropdown_theme_container", "box_model_vertical_container"]
                        },
                        "embed-url": {
                        ...
                        "link": {
                            ...
                            themes: ["studio_link_theme_container", "box_model_vertical_container"]
                        },
                        "file-upload": {
