...
export const StudioDocumentPreviewableInput =  [
  {
    uuid: "document_document_previewable_text_block",
    application_id: "1",
    name: "document previewable text block",
    ...
    childrenIds: ["document_previewable_input_block", "document_previewable_handler_block"]
  },
  {
    uuid: "document_previewable_input_block",
    application_id: "1",
    ...
    childrenIds: ["label_document_previewable"]
  },
  {
    uuid: "label_document_previewable",
    name: "label document previewable",
  ...
  {
    uuid: "document_previewable_text_input",
  ...
  {
    uuid: "document_previewable_handler_block",
    application_id: "1",
    ...
    childrenIds: ["document_previewable_text_input", "document_previewable_handler"]
  },
  {
    uuid: "document_previewable_handler",
    application_id: "1",
