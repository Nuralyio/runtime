...
export const StudioVideoPreviewableInput =  [
  {
    uuid: "video_video_previewable_text_block",
    application_id: "1",
    name: "video previewable text block",
    ...
    childrenIds: ["video_previewable_input_block", "video_previewable_handler_block"]
  },
  {
    uuid: "video_previewable_input_block",
    application_id: "1",
    ...
    childrenIds: ["label_video_previewable"]
  },
  {
    uuid: "label_video_previewable",
    name: "label video previewable",
  ...
  {
    uuid: "video_previewable_text_input",
  ...
  {
    uuid: "video_previewable_handler_block",
    application_id: "1",
    ...
    childrenIds: ["video_previewable_text_input", "video_previewable_handler"]
  },
  {
    uuid: "video_previewable_handler",
    application_id: "1",
