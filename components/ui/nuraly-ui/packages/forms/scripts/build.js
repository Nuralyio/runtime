...
// Form components to include in the package
...
async function build() {
  try {
    console.log('🚀 Building @nuralyui/forms package...\n');
    ...
    const indexContent = FORM_COMPONENTS
    ...
    const indexDtsContent = FORM_COMPONENTS
      .map(component => `export * from './${component}/index.js';`)
      .join('\n') + '\n';
    ...
    const reactContent = FORM_COMPONENTS
    ...
    // Create react.d.ts
    const reactDtsContent = FORM_COMPONENTS
      .map(component => `export * from './${component}/react.js';`)
      .join('\n') + '\n';
...
This package includes the following form components with their respective versions:
...
`;
    ...
    console.log('\n✅ @nuralyui/forms package built successfully!');
    console.log(`📂 Output: ${DIST_DIR}`);
    console.log('\n📦 Included components:');
    FORM_COMPONENTS.forEach(comp => console.log(`   - ${comp}`));
